...
public class EmployeeModelImpl
	...
	static {
		...
		attributeGetterFunctions.put("joiningDate", Employee::getJoiningDate);
		attributeSetterBiConsumers.put(
			"joiningDate",
			(BiConsumer<Employee, Date>)Employee::setJoiningDate);
		attributeGetterFunctions.put("leavingDate", Employee::getLeavingDate);
		attributeSetterBiConsumers.put(
			"leavingDate",
			(BiConsumer<Employee, Date>)Employee::setLeavingDate);
	...
	public Object clone() {
		...
		employeeImpl.setLeavingDate(getLeavingDate());
	...
	public CacheModel<Employee> toCacheModel() {
		...
		if (leavingDate != null) {
			employeeCacheModel.leavingDate = leavingDate.getTime();
		}
		else {
			employeeCacheModel.leavingDate = Long.MIN_VALUE;
		}
