package com.liferay.rk.rest.builder.internal.resource.v1_0.factory;
 ...
 * @generated
 */
@Component(immediate = true, service = UserResource.Factory.class)
@Generated("")
	...
	public UserResource.Builder create() {
		return new UserResource.Builder() {
			...
			public UserResource build() {
				...
				return (UserResource)ProxyUtil.newProxyInstance(
